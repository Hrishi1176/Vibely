...
export default function CreatePostModal({ isOpen, onClose, onPostCreated, quota, refreshQuota, initialDraft }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-md animate-fade-in">
      <div className="glass-panel w-full max-w-lg rounded-3xl border border-[var(--border-glass)] p-4 sm:p-6 space-y-4 shadow-sm relative max-h-[85vh] sm:max-h-[90vh] overflow-y-auto transition-colors duration-300">
        ...
        <div className="p-3 rounded-xl bg-[var(--accent-primary)]/15 border border-[var(--accent-primary)]/30 flex items-center justify-between text-xs">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-lg btn-gradient text-white font-medium text-xs shadow-sm shrink-0"
          >
          ...
          <div className="p-3 rounded-xl bg-[var(--bg-secondary)] border border-[var(--accent-primary)]/20 space-y-2 text-xs">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="btn-gradient px-3 py-2 rounded-lg text-white font-medium flex items-center space-x-1 disabled:opacity-50 shadow-sm shrink-0"
              >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-[var(--border-glass)]">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="btn-gradient px-5 py-2.5 rounded-xl text-white font-semibold text-sm flex items-center space-x-2 disabled:opacity-50 shadow-sm"
            >
